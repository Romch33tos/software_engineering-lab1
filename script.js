(function () {
    ...
    function calculateEfficiency() {
        ...
        // ИСПРАВЛЕНО: удалены обращения к несуществующим элементам paybackPeriod и actualEfficiency,
        // обновление итоговой таблицы происходит внутри updateTableSummary
